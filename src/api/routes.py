...
from ..monitoring.discord_notifier import alert_new_prediction, alert_model_degradation2
    ...
    try:
        ...
        if user_feedback is not None:
            ...
            if user_feedback == 0:
                ...
                try:
                    taux_negatif = sum(cv_feedback_negative_total) / sum(cv_predictions_total) * 100
